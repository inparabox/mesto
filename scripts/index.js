...
const profileButtonEdit = document.querySelector('.profile__button-edit').addEventListener('click', EditProfile);
...
const btnAddNewElement = document.querySelector('.profile__button-add').addEventListener('click', openPopUpAddNew);
...
function cloneCard(item) {
  ...
  newBox.querySelector('.element__button-like').addEventListener('click', likeNolike);
  function likeNolike() {
...
function openPopUpAddNew(){
  ...
  popupAddCard.querySelector('.popup__btn-close').addEventListener('click', closePopup);
  popupAddCard.querySelector('.popup__btn-save').addEventListener('click', addNewElement);
...
function addNewElement(evt) {
  ...
  closePopup(evt);
  popupAddCard.querySelector('.popup__btn-save').addEventListener('click', clearForm);
  console.log('Кнопка Сохранить: закрываем поп-ап ADD NEW + добавляем новый элемент');
}
